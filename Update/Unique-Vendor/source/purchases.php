							...
							<div class="row">
							  <div class="six wide column">
								<div class="ui list product-meta">
								  <div class="item">
									<div class="content">
									  <div class="header">
										<a target="_blank" style="text-decoration:none!important;color:#333!important;" href="<?php echo $web['url']; ?>p/<?php echo $row['item_id']; ?>"><?php echo $row['name']; ?></a>
									  </div>
									  Purchase code: <?php echo $row['code']; ?>
									</div>
								  </div>
								</div>
							  </div>
							  <div class="six wide right aligned column">
								<div class="ui green buttons">
								  <a title="Download <?php echo $row['name']; ?>" class="ui button download-product" href="<?php echo $web['url']; ?>download/<?php echo $row['item_id']; ?>">
									Download
								  </a>

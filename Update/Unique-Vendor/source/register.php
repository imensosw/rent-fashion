...
<body>
	...
	if(isset($_POST['phps_register'])) {
	  ...
	  $cpasswd = mysql_real_escape_string($_POST['cpasswd']);
	  $email = mysql_real_escape_string($_POST['email']);
	  $email_exists = mysql_query("SELECT * FROM purchasify_users WHERE email = '" . mysql_real_escape_string($_POST['email']) . "'");
	  $emailchecker = mysql_fetch_array($email_exists);
	  $usern_exists = mysql_query("SELECT * FROM purchasify_users WHERE usern = '" . mysql_real_escape_string($_POST['usern']) . "'");

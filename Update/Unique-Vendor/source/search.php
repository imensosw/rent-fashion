  ...
  <div class="landing-header">
    <div class="ui global-wrap">
	  ...
	  <span class="ui huge normal header inverted" style="font-weight: 300;font-size: 20px;">
			Check out the best products made by professionnals
	  </span>
	  </h1>
    </div>
  </div>
...
<div class="centered statistics">
  ...
  <div class="ui tiny statistic">
    <div class="value">
      <?php $sales = 0; $sql = mysql_query("SELECT * FROM purchasify_items ORDER BY id"); if(mysql_num_rows($sql)>0) { while($row = mysql_fetch_array($sql)) { $sales = $sales+$row['sales']; } } echo (number_format($sales) / 2); ?>
    </div>
...
<div class="centered marketplace-items single">
  ...
  <div class="ui icon input">
    <input style="border-top-right-radius:0px;border-bottom-right-radius:0px;" type="text" name="phps_query" placeholder="Search items..." <?php if(isset($_POST['phps_query'])) { echo 'value="'.protect($_POST['phps_query']).'"'; } ?>>

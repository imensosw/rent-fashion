	...
	<?php
			if(isset($_POST['phps_save'])) {
				...
				elseif(!isValidEmail($email)) { echo '<div class="alert color red-color"><p align="center">Please enter valid site email address.</p></div>'; }
					...
					$update = mysql_query("UPDATE purchasify_settings SET title='$title',description='$description',keywords='$keywords',sitename='$sitename',url='$url',email='$email',contact_email='$contact_email'");

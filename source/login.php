...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Log in - <?php echo $web['title']; ?></title>
		...
		<link rel="stylesheet" href="<?php echo $web['url']; ?>static/gen/packed_global.css"><link rel="stylesheet" href="<?php echo $web['url']; ?>static/gen/modal/css/style.css">
		<!-- End Stylesheets -->
...
<body>
    ...
    <form action="" method="post" accept-charset="utf-8" class="ui form login-container">
		...
		<div class="field">
          <a class="ui fluid twitter button" rel="nofollow" href="<?php echo $web['url']; ?>account/register">
			Don't have an account yet? Sign up <i class="fa fa-arrow-right"></i>
		  </a>
        </div>

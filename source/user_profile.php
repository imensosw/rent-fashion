...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo $web['url']; ?>static/gen/packed_newprofilepage.css"><link rel="stylesheet" href="<?php echo $web['url']; ?>static/gen/modal/css/style.css">
		<!-- End Stylesheets -->

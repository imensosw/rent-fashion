...
-->
	...
	<?php
			...
			if(isset($_POST['phps_save'])) {
				...
				$cur_user_address = mysql_real_escape_string($_POST['cur_user_address']);

				$cur_user_address_shipping = mysql_real_escape_string($_POST['cur_user_address_shipping']);
        ...
        <div class="ui grid form change-password">
            ...
            <div class="row">
                ...
                <div class="column field">
                    ...
                    <input id="address" name="cur_user_address" type="text" value="<?php echo protect(idinfo($_SESSION['ps_usern'],"user_address")); ?>" autocomplete="off" required>
            ...
            <div class="row">
                ...
                <div class="column field">
                    ...
                    <input id="address" name="cur_user_address_shipping" type="text" value="<?php echo protect(idinfo($_SESSION['ps_usern'],"user_address_shipping")); ?>" autocomplete="off" required>

		...
		<div class="ui fluid vertical menu">
		  ...
		  <div class="item submenu-wrap">
			<div class="menu submenu">
                ...
                <!--<a class="green item " href="<?php //echo $web['url']; ?>" data-pushstate="true">
				  Purchase product
				</a>-->
		  ...
		  <div id="container_for_page_body">
			<div id="dashboard_header" class="graph_dashboard">
						...
						<div class="row">
							<div class="center aligned column dashboard-product-info-box">
								<div class="ui statistic">
									...
									<?php $downloads = 0; $sql = mysql_query("SELECT * FROM purchasify_items ORDER BY id"); if(mysql_num_rows($sql)>0) { while($row = mysql_fetch_array($sql)) { $downloads = $downloads+$row['downloads']; } } echo number_format($downloads); ?></div>
				...
				<?php } ?>
					...
					<div class="ui three column stackable grid">
						<div class="row">
						  <iframe width="100%" height="" src="https://static.spreadrr.com/purchasify/news" name="preview-frame" frameborder="0" noresize="noresize"></iframe>
						</div>
					</div>
				</div>
			</div>

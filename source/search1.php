...
<html lang="en">
	<head>
		...
		<?php include($_SERVER['DOCUMENT_ROOT']."/purchasify/static/gen/modal/header-modal.php"); ?>
...
<div class="centered marketplace-items single">
  ...
  <div class="ui items">
	<?php
	echo $phps_query = mysql_real_escape_string($_POST['phps_query']);
	echo $phps_query1 = mysql_real_escape_string($_POST['phps_query1']);
	echo $phps_brand_query = mysql_real_escape_string($_POST['phps_brand_query']);

	echo $phps_size_query = mysql_real_escape_string($_POST['phps_size_query']);
  ...
  <!-- NOT FEATURED ITEMS END -->
	...
	<!-- FOOTER CODE -->
	<?php include($_SERVER['DOCUMENT_ROOT']."/purchasify/static/gen/modal/footer-modal.php"); ?>

...
if($_GET['confirmed'] == "yes") 
{
	...
	$delete = mysql_query("DELETE FROM purchasify_items WHERE id='$id'");
...
else 
{
	...
	echo '<center><a style="text-decortion:none!important;color:#fff!important;" class="ui tiny flat red button" href="'.$web[url].'confirm_delete/'.$row[id].'">Yes</a>&nbsp;&nbsp;<a style="text-decortion:none!important;color:#fff!important;" class="ui tiny flat green button" href="'.$web[url].'dashboard">No</a></center>';
}
?>
<?php 
